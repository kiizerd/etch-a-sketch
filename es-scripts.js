  ...
  squares.forEach(square => {
    ...
    switch (color) {
      ...
      case 'darken':
        let color1, color2;
        square.addEventListener('mouseenter', () => {
          color1 = square.style.backgroundColor;
          color2 = pSBC(-0.1, color1);
          brushColor = color2;
          square.style.backgroundColor = brushColor;
        });
        break;
      case 'rainbow':
        square.addEventListener('mouseenter', () => {
          brushColor = rColors[Math.floor(Math.random() * rColors.length)];
          square.style.backgroundColor = brushColor;
        });
        break;
      case 'black':
